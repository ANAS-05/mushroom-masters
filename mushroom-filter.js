...
function filterCards() {
  ...
  cards.forEach((card) => {
    const season = card.querySelector("[data-season]").dataset.season;      //dataset converts data-* attributes into camelCase property names.So, data-season would become season in JavaScript.
